...
*/
    ...
    static Fine myFine = new Fine("xasd134fqf32", "John Doe", 187.50, new DateTime(2022, 12,31), false);
...
*/
    Console.WriteLine(myFine.AmountDue);
    Console.WriteLine(myFine.IsPaid);
    Console.WriteLine(myFine.DateIssued);
    }
}
